                    ...
                    <div class="topbar-one__left">
                        <ul class="topbar-one__info">
                            <li class="topbar-one__info-item">
                                ...
                                <span class="topbar-one__info-text">Taxtapul Darvoza, 328, Nexus biznes markazi, 103-xona
                                </span>
                            </li>
                            <li class="topbar-one__info-item">
                                <span class="topbar-one__info-icon icon-envelope"></span>
                                <a href="mailto:multifly.travel@gmail.com"
                                    class="topbar-one__info-text">multifly.travel@gmail.com</a>
                            </li>
                        </ul><!-- /.topbar-one__info -->
